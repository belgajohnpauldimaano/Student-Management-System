...
class GradeSheetController extends Controller
{
    ...
    public function print_grades (Request $request)
    {
        ...
        if ($StudentInformation) 
        {
            ...
            // $GradeSheetData = json_decode(json_encode($GradeSheetData));
            // $pdf = \PDF::loadView('control_panel_student.grade_sheet.partials.print', compact('StudentEnrolledSubject','GradeSheetData', 'grade_level', 'StudentInformation', 'ClassDetail', 'general_avg', 'Semester'));
