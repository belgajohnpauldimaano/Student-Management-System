    ...
    function saveData(formData) {
        $.ajax({
            ...
            success     : function (res) {
                ...
                {
                    alertify.confirm('Assessment confirmation',
                        '<div class="text-center"><h4>Assessment is successfully done</br>Your score is</h4><br/><h1>' + res.score + '/' + res.total_item + '</h1>'+
