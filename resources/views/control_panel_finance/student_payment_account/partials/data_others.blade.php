            ...
            <div class="col-md-6">
                <div class="card card-danger card-solid">
                    <div class="card-header">
                        <h3 class="card-title">Other(s)</h3>
                    </div>
                    <div class="card-body">
                ...
                <div class="card card-danger card-solid">
                    ...
                    <div class="card-body">   
                            ...
                            <div class="form-group" style="margin-top: 10px" align="right">                
                                <button type="submit" id="js-btn-others-save" data-id='1' class="btn btn-primary">
                                    <i class="fas fa-save"></i> Save
                                </button>
                                <button type="button" class="btn btn-danger" id="js-btn_print_others"
