            ...
            <div class="card">
                <div class="card-header">
                    <ul class="nav nav-pills">
                        <li class="nav-item">
                            <a href="#payment" class="nav-link active" data-toggle="tab">Payment</a>
                        </li>
                        <li class="nav-item">
                            <a href="#other" class="nav-link" data-toggle="tab">Other(s)</a>
                        </li>
                        <li class="nav-item">
                            <a href="#discount" class="nav-link" data-toggle="tab">Discount(s)</a>
                        </li>
                    </ul>
                </div><!-- /.card-header -->
                <div class="card-body">
                        ...
                        <div class="tab-pane" id="discount">
                            ...
                            <form  id="js-discount_fee">
                                ...
                                <div class="card card-danger card-solid">
                                    <div class="card-header">
                                        <h3 class="card-title">Discount(s)</h3>
                                    </div>
                                    <div class="card-body">
