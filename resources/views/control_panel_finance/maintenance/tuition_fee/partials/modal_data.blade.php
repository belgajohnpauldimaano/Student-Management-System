            ...
            <form id="js-form_tuition_fee">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="tuition_fee" value="{{ $TuitionFee ? $TuitionFee->tuition_amt : '' }}">
                    ...
                    <div class="form-group">
                        ...
                        <select name="current_sy" id="current_sy" class="form-control">
                            <option value="1" {{ $TuitionFee ? ($TuitionFee->current == 0 ? 'selected' : '')  : 'selected' }}>Yes</option>
                            <option value="0" {{ $TuitionFee ? ($TuitionFee->current == 0 ? 'selected' : '')  : '' }}>No</option>
                        </select>
