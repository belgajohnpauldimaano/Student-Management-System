<div class="list-group list-group-sidebar">
	...
	<a class="list-group-item text-muted {{ Request::is('vision-mission') ? 'selected' : '' }}" href="{{ route('vision_mission') }}">Vision  Mission</a>
	<a class="list-group-item text-muted {{ Request::is('philosophy') ? 'selected' : '' }}" href="{{ route('philosophy') }}">Philosophy</a>
