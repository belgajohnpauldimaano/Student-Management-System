		...
		<div class="container">
			<div class="row">
				<div class="col-md-8">
					...
					<p>SJAI believes that every learner's unique gifts and blended intelligences comes 
						from God; engages in its discovery, development, and nurturance towards full humanity</p>		
					<br>
					<br>
				</div>
				<div class="col-md-4">
