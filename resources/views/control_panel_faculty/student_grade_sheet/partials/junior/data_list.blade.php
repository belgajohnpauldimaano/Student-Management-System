<button class="btn btn-primary float-right mb-1" id="js-btn_print" data-id="{{ $ClassSubjectDetail->id }}">
    <i class="fa fa-file-pdf"></i> Print
</button>
<div class="table-responsive  table-responsive-sm" style="height: 600px;">
    <table class="table no-margin table-head-fixed table-sm table-hover">
        <thead>
            <tr>
                <th>#</th>
                <th>Student Name</th>                                        
