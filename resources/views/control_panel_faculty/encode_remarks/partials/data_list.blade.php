                ...
                @foreach ($EnrollmentMale as $key => $data) 
                    <form id="js_lacking_units_jr">
                        ...
                        <tr>
                            ...
                            <td>{{ $data->student_name }}</td>                            
                            <td>   
                                <input type="text" class="form-control" name="grade" value="{{ $data->eligible_transfer }}" placeholder="Grade">                                              
                            </td>
                            <td>
                                @if($ClassSubjectDetail->grade_level < 11) 
                                    <input type="text" class="form-control" name="jlacking_units" value="{{ $data->s1_lacking_unit }}" placeholder="none"> 
...
>>>>>>> 785e165cdcd69c7151ac7afe6e69fb20f01d5673
                                    @else
