                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group date">
                                                        ...
                                                        <input type="text" name="birthdate" class="form-control pull-right" id="datepicker" value="{{ $data ? date_format(date_create( $data->birthdate), 'm/d/Y') : '' }}">
                                                    </div>
                                                    <div class="help-block text-red text-center" id="js-birthdate">
                                                    </div>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="age_june" value="{{ $data ? $data->age_june : '' }}">
                                                    <div class="help-block text-red text-center" id="js-age_june">
                                                    </div>                                                    
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="age_may" value="{{ $data ? $data->age_may : '' }}">
                                                    <div class="help-block text-red text-center" id="js-age_may">
                                                    </div>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="address" value="{{ $data ? $data->c_address : '' }}">
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" name="guardian" value="{{ $data ? $data->guardian : '' }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group date">
                                                        ...
                                                        <input type="text" name="birthdate" class="datepicker form-control pull-right datails_input" id="datepicker{{ $key + 1 }}" value="{{ $data ? date_format(date_create( $data->birthdate), 'm/d/Y') : '' }}">
                                                    </div>
                                                    
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control input-sm datails_input" name="age_june" id="age_june_{{ $data->id }}" value="{{ $data ? $data->age_june : '' }}">
                                                    {{-- <div class="help-block text-red text-center" id="js-age_june">
                                                    </div>                                                     --}}
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control input-sm datails_input" name="age_may" value="{{ $data ? $data->age_may : '' }}">
                                                    {{-- <div class="help-block text-red text-center" id="js-age_may">
                                                    </div> --}}
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control input-sm datails_input" name="address" value="{{ $data ? $data->c_address : '' }}">
                                                    {{-- <div class="help-block text-red text-center" id="js-address">
                                                    </div> --}}
                                                </td>
                                                {{-- <td> <select name="gender" id="gender" class="form-control">
                                                ...
                                                <td>
                                                    <input type="text" class="form-control input-sm datails_input" name="guardian" value="{{ $data ? $data->guardian : '' }}">
                                                    {{-- <div class="help-block text-red text-center" id="js-guardian">
                                                    </div> --}}
                                                </td>
                                                {{-- <td>{{ $data->father_name }}</td> --}}
...
@section ('scripts')
    ...
    <script>
        ...
        $('body').on('keyup', '.datails_input', function () {
