                    ...
                    <div class="modal-body">   
                        ...
                        <div class="form-group">
                            ...
                            <select name="gender" id="gender" class="form-control">
                                <option value="" {{ $Profile ? $Profile->isEsc == 0 ? 'selected' : '' : '' }}>Select a gender</option>
                                <option value="2" {{ $Profile ? $Profile->gender == 1 ? 'selected' : '' : '' }}>Female</option>
                                <option value="1" {{ $Profile ? $Profile->gender == 2 ? 'selected' : '' : '' }}>Male</option>
                            </select>
                            <div class="help-block text-left" id="js-contact_number"></div>
                        </div>
                        <div class="form-group">
