            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="js-data-container">
                        @include('control_panel.student_attendance.partials.data_list')
                    </div>
                </div>
            </div>
        </div>
...
@section ('scripts')
    ...
    <script>        
        ...
        function fetch_data () {
            ...
            loader_overlay();
            $.ajax({
                url : "{{ route('admin.maintenance.student_attendance') }}",
                type : 'POST',
                data : formData,
                processData : false,
                contentType : false,
        ...
        $(function () {
            $('body').on('click', '#js-button-add, .js-btn_update_sy', function (e) {
                ...
                var id = $(this).data('id');
                $.ajax({
                    url : "{{ route('admin.maintenance.student_attendance.modal_data') }}",
                    type : 'POST',
