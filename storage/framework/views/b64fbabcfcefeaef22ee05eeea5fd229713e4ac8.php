...
<head>
    ...
    <title>
        PRINT - <?php echo e($quarter); ?> Quarter
    </title>
...
<body>
    ...
    <p class="report-progress m0">S.Y. <?php echo e($ClassSubjectDetail ? $ClassSubjectDetail->school_year : ''); ?></p>
    <p class="report-progress m0">GRADESHEET</p>
    
    <img style="margin-top: -.4em; margin-left: 9em" class="logo" width="100" src="<?php echo e(asset('img/sja-logo.png')); ?>" />
    <br/>
    <br/>
    
    
    <p class="p0 m0 student-info">Grade & Section : <b><?php echo e($ClassSubjectDetail ? $ClassSubjectDetail->grade_level : ''); ?> - <?php echo e($ClassSubjectDetail ? $ClassSubjectDetail->section : ''); ?></b</p>
    <p class="p0 m0 student-info">Quarter : <b><i><?php echo e($quarter); ?></i></b></p>
    <br/>
   
  <?php if($quarter == "Fourth"): ?>

        <?php if($ClassSubjectDetail->grade_level == 7 || $ClassSubjectDetail->grade_level == 8 || $ClassSubjectDetail->grade_level == 9 || $ClassSubjectDetail->grade_level == 10): ?>
  ...
  <?php else: ?>
    ...
    <?php if($ClassSubjectDetail->grade_level == 7 || $ClassSubjectDetail->grade_level == 8 || $ClassSubjectDetail->grade_level == 9): ?>
    ...
    <?php endif; ?>
 <?php endif; ?>
    <p style="text-align: right; font-size: 12px"><b><?php echo e($ClassSubjectDetail->first_name); ?> <?php echo e($ClassSubjectDetail->middle_name); ?> <?php echo e($ClassSubjectDetail->last_name); ?></b> - <i>Class Adviser</i></p>
