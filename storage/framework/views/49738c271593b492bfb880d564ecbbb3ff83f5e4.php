    ...
    <table class="table no-margin table-striped table-bordered" style="font-size: 13px">
            ...
            <tr>
                <?php if($quarter == 'First - Second'): ?>
                    <tr>
                        ...
                        <td colspan="<?php echo e($Totalsubject_1st_sem); ?>">
                            <center>
                                <b>First Sem</b>
                            </center>
                        </td>
                        <td colspan="<?php echo e($Totalsubject_2nd_sem); ?>">
                            <center>
                                <b>Second Sem</b>
                            </center>
                        </td>
                    ...
                    <?php $__currentLoopData = $Subject_1stsem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                     
                        <th style="padding-left: 2px !important; padding-right: 2px !important; text-align: center"><?php echo e($sub->subject_code); ?> </th>                                                                  
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    
                    <?php $__currentLoopData = $Subject_2ndsem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                     
                        <th style="padding-left: 2px !important; padding-right: 2px !important; text-align: center"><?php echo e($sub->subject_code); ?> </th>                                                                  
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>                    
        ...
        <tbody>
            <tr>
                <td colspan="<?php echo e($Totalsubject_1st_sem + $Totalsubject_2nd_sem + 4); ?>">
                    <b>Male</b>
                </td>
            </tr>
            ...
            <?php $__currentLoopData = $GradeSheetMale; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <?php $__currentLoopData = $Enrollment1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <td>
                                        <center>
                                        <?php
                                ...
                                <?php $__currentLoopData = $Enrollment2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <td>
                                        <center>
                                        <?php 
                                ...
                                <?php if(round($final_ave) >= 75 && round($final_ave) <= 89): ?>
                                    <td>
                                        <center>Passed</center>
                                    </td>
                                <?php elseif(round($final_ave) >= 90 && round($final_ave) <= 94): ?>
                                    <td>
                                        <center>with honors</center>
                                    </td>
                                <?php elseif(round($final_ave)>= 95 && round($final_ave) <= 97): ?>
                                    <td>
                                        <center>with high honors</center>
                                    </td>
                                <?php elseif(round($final_ave) >= 98 && round($final_ave) <= 100): ?>
                                    <td>
                                        <center>with highest honors</center>
                                    </td>
                                <?php elseif(round($final_ave) < 75): ?>
                                    <td>
