            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-6 footer-info">
                        <h3>St. John's</h3>
                        <p>ST. JOHN'S ACADEMY INC was born out of a clamor for a Catholic educational institution which will provide a deeply-rooted Christian formation to the young and which can supply the volunteers for the Parochial catechetical program at the public schools within the parish... <a href="<?php echo e(route('history')); ?>">readmore</a></p>
                    </div>
                    <div class="col-lg-4 col-md-6 footer-links">
                        <h4>About SJAI</h4>
                        <ul>
                            <li><i class="ion-ios-arrow-right"></i> <a href="<?php echo e(route('home_page')); ?>">Home</a></li>
                            <li><i class="ion-ios-arrow-right"></i> <a href="<?php echo e(route('vision_mission')); ?>">Vision Mission</a></li>
                            <li><i class="ion-ios-arrow-right"></i> <a href="<?php echo e(route('history')); ?>">Hymn</a></li>
                            <li><i class="ion-ios-arrow-right"></i> <a href="<?php echo e(route('faculty_staff')); ?>">Faculty and Staff</a></li>
                        </ul>
                    </div>
    ...
    <script src="<?php echo e(asset('theme/lib/jquery/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('theme/lib/jquery/jquery-migrate.min.js')); ?>"></script>
    <script src="<?php echo e(asset('theme/lib/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>
    <script src="<?php echo e(asset('theme/lib/easing/easing.min.js')); ?>"></script>
    <script src="<?php echo e(asset('theme/lib/superfish/hoverIntent.js')); ?>"></script>
    <script src="<?php echo e(asset('theme/lib/superfish/superfish.min.js')); ?>"></script>
    <script src="<?php echo e(asset('theme/lib/wow/wow.min.js')); ?>"></script>
    <script src="<?php echo e(asset('theme/lib/waypoints/waypoints.min.js')); ?>"></script>
    <script src="<?php echo e(asset('theme/lib/counterup/counterup.min.js')); ?>"></script>
    <script src="<?php echo e(asset('theme/lib/owlcarousel/owl.carousel.min.js')); ?>"></script>
    <script src="<?php echo e(asset('theme/lib/isotope/isotope.pkgd.min.js')); ?>"></script>
    <script src="<?php echo e(asset('theme/lib/lightbox/js/lightbox.min.js')); ?>"></script>
    <script src="<?php echo e(asset('theme/lib/touchSwipe/jquery.touchSwipe.min.js')); ?>"></script>
    <!-- Contact Form JavaScript File -->
    <script src="<?php echo e(asset('theme/contactform/contactform.js')); ?>"></script>
    <!-- Template Main Javascript File -->
    <script src="<?php echo e(asset('theme/js/main.js')); ?>"></script>
    
    <script src="<?php echo e(asset('cms/plugins/alertifyjs/alertify.min.js')); ?>"></script>
    <!-- jquery-toast-plugin -->
    <script src="<?php echo e(asset('cms/plugins/jquery-toast-plugin/jquery.toast.min.js')); ?>"></script>
    <!-- alertifyjs -->
    <script src="<?php echo e(asset('cms/plugins/alertifyjs/alertify.min.js')); ?>"></script>
    <script src="<?php echo e(asset('cms/plugins/datepicker/bootstrap-datepicker.js')); ?>"></script>
    <link rel="stylesheet" href="<?php echo e(asset('cms/plugins/datepicker/datepicker3.css')); ?>">
    <script>
        $('#birthday').datepicker({
            autoclose: true
        })
    ...
    <script>
        $(function () {
            ...
            $('body').on('submit', '#js-form_subject_details', function (e) {
                ...
                'Are you sure you want to register? Please make sure your input are all correct. Thank you', function(){ 
                    ...
                    {
                            $.ajax({
                                url         : "<?php echo e(route('registration.store')); ?>",
                                type        : 'POST',
                                data        : formData,
                                processData : false,
                                contentType : false,
        ...
        $grade7_list = "<?php echo e(asset('json/grade7_list.json')); ?>";
        ...
        $url_reservatoin = "<?php echo e(asset('json/list_reservation.json')); ?>";
        ...
        $entrance_passer = "<?php echo e(asset('json/entrance_passer.json')); ?>";
        ...
        $waiting_jan2020 = "<?php echo e(asset('json/waiting_jan2020.json')); ?>";
        ...
        $list_feb2020 = "<?php echo e(asset('json/list_feb2020.json')); ?>";
        ...
        $waiting_feb2020 = "<?php echo e(asset('json/waiting_feb2020.json')); ?>";
