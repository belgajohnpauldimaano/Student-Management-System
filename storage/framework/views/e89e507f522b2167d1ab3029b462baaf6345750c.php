<html>
    ...
    <div style="padding: 20px">
        ...
        <p>You have new appointment from MR. <?php echo e($hasAppointment->student->last_name.', '.$hasAppointment->student->first_name); ?>, Please see details below:</p>
        ...
        <table border="1" style="border-color: #666;border-collapse: collapse;width:100%; " cellpadding="5">
            ...
            <tbody>
                <tr>
                    <td><?php echo e($hasAppointment ? date_format(date_create($hasAppointment->appointment->date), 'F d, Y') : ''); ?></td>
                    <td><?php echo e($hasAppointment->appointment->time); ?></td>
                    <td><?php echo e($hasAppointment->queueing_number); ?></td>
                </tr>
            </tbody>
        </table>
        <br/>
