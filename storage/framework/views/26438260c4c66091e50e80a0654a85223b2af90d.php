                ...
                <div class="modal-body">
                    <div class="form-group" align="center">
                        ...
                        <img class="profile-user-img img-responsive img-circle" 
                            id="img--user_photo" 
                            src="<?php echo e($Profile->photo ? \File::exists(public_path('/img/account/photo/'.$Profile->photo)) ? 
                    ...
                    <form id="form--update-profile">
                        ...
                        <div class="form-group gender">
                            ...
                            <select name="isEsc" id="isEsc" class="form-control">
                                <option value="0" <?php echo e($StudentInformation ? $StudentInformation->isEsc == 0 ? 'selected' : '' : 'selected'); ?>>--Select--</option>
                                <option value="1" <?php echo e($StudentInformation ? $StudentInformation->isEsc == 1 ? 'selected' : '' : ''); ?>>Yes</option>
                                <option value="2" <?php echo e($StudentInformation ? $StudentInformation->isEsc == 2 ? 'selected' : '' : ''); ?>>No</option>
                            </select>
