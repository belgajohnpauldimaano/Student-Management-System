...
<div class="table-responsive">
    <table class="table no-margin table-bordered">
        ...
        <tbody>
            ...
            <?php $__currentLoopData = $Enrollment_first_sem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td>
                    <?php
                ...
                <?php if($StudentEnrolledSubject1): ?>                                
                    <?php if(round($StudentEnrolledSubject1->fir_g) != 0 && round($StudentEnrolledSubject1->sec_g) != 0): ?> 
    ...
    <?php echo $__env->make('control_panel_student.grade_sheet.partials.grade_panel.senior.first_sem.attendance', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
</div>