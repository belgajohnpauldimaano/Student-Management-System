    ...
    <div class="box">
        ...
        <div class="box-body">
            <div class="js-data-container">
                <?php echo $__env->make('control_panel.transcript_archieve.partials.data_list', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        function fetch_data () {
            ...
            loader_overlay();
            $.ajax({
                url : "<?php echo e(route('admin.transcript_archieve')); ?>",
                type : 'POST',
                data : formData,
                processData : false,
                contentType : false,
        ...
        $(function () {
            ...
            $('body').on('click', '#js-button-add, .js-btn_update_sy', function (e) {
                ...
                var id = $(this).data('id');
                $.ajax({
                    url : "<?php echo e(route('admin.transcript_archieve.modal_data')); ?>",
                    type : 'POST',
            ...
            $('body').on('click', '.js-btn_download', function (e) {
                ...
                $.ajax({
                    url : "<?php echo e(route('admin.transcript_archieve.download_tor')); ?>",
                    type : 'POST',
                    data : { _token : '<?php echo e(csrf_token()); ?>', id : id, file_name: file },
                    success : function (res) {
                        if (res.res_code == 1) {
                            show_toast_alert({
                                heading : 'Error',
            ...
            $('body').on('submit', '#js-form_transcript', function (e) {
                ...
                $.ajax({
                    url         : "<?php echo e(route('admin.transcript_archieve.save_transcript')); ?>",
                    type        : 'POST',
                    data        : formData,
                    processData : false,
                    contentType : false,
            ...
            $('body').on('click', '.js-btn_delete', function (e) {
                ...
                alertify.confirm('Confirmation', 'Are you sure you want to deactivate?', function(){  
                    $.ajax({
                        url         : "<?php echo e(route('admin.transcript_archieve.delete_data')); ?>",
                        type        : 'POST',
                        data        : { _token : '<?php echo e(csrf_token()); ?>', id : id },
                        success     : function (res) {
                            $('.help-block').html('');
            ...
            $('body').on('click', '.js-btn_view_additional_info', function (e) {
                ...
                var id = $(this).data('id');
                $.ajax({
                    url : "<?php echo e(route('admin.faculty_information.additional_information')); ?>",
                    type : 'POST',
                    data : { _token : '<?php echo e(csrf_token()); ?>', id : id },
                    success : function (res) {
                        $('.js-modal_holder').html(res);
