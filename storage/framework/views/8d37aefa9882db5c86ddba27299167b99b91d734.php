    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Search</h3>
                ...
                <?php if($ClassSubjectDetail->grade_level <= 10): ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        function fetch_data () {
            ...
            loader_overlay();
            $.ajax({
                url : "<?php echo e(route('faculty.student_grade_sheet.list_students_by_class')); ?>",
                type : 'POST',
                data : formData,
                processData : false,
                contentType : false,
        ...
        $(function () {
            ...
            $('body').on('change', '#search_sy', function () {
                $.ajax({
                    url : "<?php echo e(route('faculty.student_grade_sheet.list_class_subject_details')); ?>",
                    type : 'POST',
            ...
            function fetch_data1() {
                ...
                $.ajax({
                    url : "<?php echo e(route('faculty.student_grade_sheet.list_students_by_class1')); ?>",
                    type : 'POST',
                    data : formData,
                    processData : false,
                    contentType : false,
            ...
            $('body').on('change', '#search_sy1', function () {
                $.ajax({
                    url : "<?php echo e(route('faculty.student_grade_sheet.semester')); ?>",
                    type : 'POST',
                    
                    data        : {_token: '<?php echo e(csrf_token()); ?>', search_sy1: $('#search_sy1').val()},
                    success     : function (res) {
            ...
            $('body').on('change', '#search_semester', function () {
                $.ajax({
                    url : "<?php echo e(route('faculty.student_grade_sheet.list_class_subject_details1')); ?>",
                    type : 'POST',
                    
                    data        : {_token: '<?php echo e(csrf_token()); ?>', search_semester: $('#search_semester').val(), search_sy1: $('#search_sy1').val()},
                    success     : function (res) {
            ...
            $('body').on('change', '.txt-grade_input', function () {
                ...
                $.ajax({
                    url         : "<?php echo e(route('faculty.student_grade_sheet.temporary_save_grade')); ?>",
                    type        : 'POST',
                    data        : { _token : '<?php echo e(csrf_token()); ?>', student_enrolled_subject_id : student_enrolled_subject_id, enrollment_id : enrollment_id, grade : grade, grading : grading, classSubjectDetailID : classSubjectDetailID },
                    success     : function (res) {
            ...
            $('body').on('click', '.btn--save-grade', function (e) {
                ...
                alertify.confirm('Confirmation', 'Are you sure you want to save?', function(){  
                    $.ajax({
                        url         : "<?php echo e(route('faculty.student_grade_sheet.save_grade')); ?>",
                        type        : 'POST',
                        data        : { _token : '<?php echo e(csrf_token()); ?>', student_enrolled_subject_id : student_enrolled_subject_id, enrollment_id : enrollment_id, grade : grade, grading : grading , classSubjectDetailID : classSubjectDetailID},
                        success     : function (res) {
            ...
            $('body').on('click', '#js-btn_finalize', function (e) {
                ...
                alertify.confirm('Confirmation', 'Are you sure you want to finalize?', function(){  
                    $.ajax({
                        url         : "<?php echo e(route('faculty.student_grade_sheet.finalize_grade')); ?>",
                        type        : 'POST',
            ...
            $('body').on('click', '#js-btn_print', function (e) {
                ...
                window.open("<?php echo e(route('faculty.student_grade_sheet.list_students_by_class_print')); ?>?search_class_subject="+search_class_subject+'&search_sy='+search_sy, '', 'height=800,width=800')
            })
            ...
            //     window.open("<?php echo e(route('faculty.student_grade_sheet.list_students_by_class_print1')); ?>?search_class_subject_sem="+search_class_subject_sem+'&search_sy1='+search_sy1, '', 'height=800,width=800')
            // })
