        ...
        <form id="js-form_subject_details">
            ...
            <div class="modal-body">
                <div class="form-row mb-5" align="center">
                    <div class="col-md-12">
                        <img class="profile-user-img img-responsive img-circle" id="img--user_photo" src="<?php echo e(asset('/img/account/photo/blank-user.gif')); ?>" 
                        ...
                        <input type="file" class="btn-upload-photo" style="display: none" id="student_img" name="student_img" src=""
                         ...
                         <input type="hidden" id="default-img" value=<?php echo e(asset('/img/account/photo/blank-user.gif')); ?> />   
                ...
                <div class="form-row">
                    <div class="form-group col-md-6 input-student_email">
                        ...
                        <input type="text" class="form-control" id="student_email" name="email" placeholder="youremail@emailprovider.com">
                        <div class="help-block text-red text-left" id="js-student_email">
                        </div>
                    </div>
                    <div class="form-group col-md-6 input-phone">
                        <label for="phone">Phone number</label>
                        <input type="text" class="form-control" id="phone" name="phone" value="+639">
