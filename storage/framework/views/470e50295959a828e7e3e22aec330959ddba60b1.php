    ...
    <div class="box">
        ...
        <div class="box-body">
            <div class="js-data-container">
                <?php echo $__env->make('control_panel_registrar.class_details.partials.data_list', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
        </div>
    ...
    <script>
        ...
        $(function () {
            $('body').on('click', '#js-button-add, .js-btn_update', function (e) {
                ...
                var id = $(this).data('id');
                $.ajax({
                    url : "<?php echo e(route('registrar.class_details.modal_data')); ?>",
                    type : 'POST',
