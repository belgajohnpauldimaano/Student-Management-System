    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="js-data-container">
                <?php echo $__env->make('control_panel_finance.payment_summary.partials.data_list', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>       
            </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        function fetch_data (date_from = '', date_to = '') {
            $.ajax({
            url:"<?php echo e(route('finance.summary.fetch_record')); ?>",
            method:"POST",
            data:{ _token : '<?php echo e(csrf_token()); ?>', date_from : date_from,  date_to : date_to},
            dataType:"json",
        ...
        $('body').on('click', '#js-btn_print', function (e) {
            ...
            window.open("<?php echo e(route('finance.summary.print')); ?>?date_from="+date_from+"&date_to="+date_to, '', 'height=800,width=800')
        })
