            ...
            <div class="col-sm-12">
                <div class="overlay hidden" id="js-loader-overlay"><i class="fa fa-refresh fa-spin"></i></div>
                    ...
                    <div class="js-data-container">
                        <?php echo $__env->make('control_panel_student.online_appointment.partials.data_list', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>     
                    </div>
                </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        function fetch_data () {
            ...
            loader_overlay();
            $.ajax({
                url : "<?php echo e(route('student.student_appointment')); ?>",
                type : 'POST',
                data : formData,
                processData : false,
                contentType : false,
        ...
        $('body').on('click', '.btn-reserve', function (e) {
                ...
                alertify.confirm('<i style="color: red !important" class="icon fa fa-warning"></i> Confirmation', 'You reserve to Date: <b>'+date+'</b> Time <b>'+time+'</b>?', function(){  
                    ...
                    if(isValidEmailAddress(email)){
                        $.ajax({
                            url         : "<?php echo e(route('student.student_appointment.reserve')); ?>",
                            type        : 'POST',
                            data        : { _token : '<?php echo e(csrf_token()); ?>', id : id , email : email, grade_lvl : grade_lvl},
                            success     : function (res) {
                                $('.help-block').html('');
                                if (res.res_code == 1)
                                {
