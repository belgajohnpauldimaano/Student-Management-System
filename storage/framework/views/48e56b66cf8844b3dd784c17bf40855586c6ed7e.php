    ...
    <div class="box">
        ...
        <div class="box-body">
            <div class="js-data-container">
                <?php echo $__env->make('control_panel.student_information.partials.data_list', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        function fetch_data () {
            ...
            loader_overlay();
            $.ajax({
                url : "<?php echo e(route('admin.student.information')); ?>",
                type : 'POST',
                data : formData,
                processData : false,
                contentType : false,
        ...
        $(function () {
            $('body').on('click', '#js-button-add, .js-btn_update_sy', function (e) {
                ...
                var id = $(this).data('id');
                $.ajax({
                    url : "<?php echo e(route('admin.student.information.modal_data')); ?>",
                    type : 'POST',
            ...
            $('body').on('click', '.js-btn_print_grade', function (e) {
                ...
                var id = $(this).data('id');
                $.ajax({
                    url : "<?php echo e(route('admin.student.information.print_student_grade_modal')); ?>",
                    type : 'POST',
                    data : { _token : '<?php echo e(csrf_token()); ?>', id : id },
                    success : function (res) {
                        $('.js-modal_holder').html(res);
            ...
            $('body').on('click', '#js-btn_print_student_grade', function (e) {
                ...
                window.open("<?php echo e(route('admin.student.information.print_student_grades')); ?>?id="+id+"&cid="+print_sy, '', 'height=800,width=800')
            ...
            $('body').on('submit', '#js-form_subject_details', function (e) {
                ...
                $.ajax({
                    url         : "<?php echo e(route('admin.student.information.save_data')); ?>",
                    type        : 'POST',
                    data        : formData,
                    processData : false,
                    contentType : false,
            ...
            $('body').on('click', '.js-btn_deactivate', function (e) {
                ...
                alertify.confirm('Confirmation', 'Are you sure you want to deactivate?', function(){  
                    $.ajax({
                        url         : "<?php echo e(route('admin.student.information.deactivate_data')); ?>",
                        type        : 'POST',
                        data        : { _token : '<?php echo e(csrf_token()); ?>', id : id },
                        success     : function (res) {
                            $('.help-block').html('');
            ...
            function readURL(input) {
                ...
                if (input[0].files && input[0].files[0] && (ext == "gif" || ext == "png" || ext == "jpeg" || ext == "jpg")) {
                    ...
                    reader.onload = function (e) {
                        ...
                        $.ajax({
                            url : "<?php echo e(route('admin.student.change_my_photo')); ?>",
                            type : 'POST',
                            data : formData,
                            processData : false,
                            contentType : false,
