...
<?php $__env->startSection('content_title'); ?>
    Class Subjects (<?php echo e("SY: " . $ClassDetail->school_year . " Yr/Sec: " . $ClassDetail->grade_level . "/" . $ClassDetail->section . " Room : " . $ClassDetail->room_code); ?>)
<?php $__env->stopSection(); ?>
    ...
    <div class="box">
        ...
        <div class="box-body">
            <div class="js-data-container">
                <?php echo $__env->make('control_panel_registrar.class_subjects.partials.data_list', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
        </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        function fetch_data () {
            ...
            loader_overlay();
            $.ajax({
                url : "<?php echo e(route('registrar.class_subjects', $class_id)); ?>",
                type : 'POST',
                data : formData,
                processData : false,
                contentType : false,
        ...
        $(function () {
            $('body').on('click', '#js-button-add, .js-btn_update', function (e) {
                ...
                $.ajax({
                    url : "<?php echo e(route('registrar.class_subjects.modal_data', $class_id)); ?>",
                    type : 'POST',
                    data : { _token : '<?php echo e(csrf_token()); ?>', class_subject_details_id : class_subject_details_id, class_details_id: <?php echo e($class_id); ?> },
                    success : function (res) {
            ...
            $('body').on('submit', '#js-form_subject_details', function (e) {
                ...
                $.ajax({
                    url         : "<?php echo e(route('registrar.class_subjects.save_data', $class_id)); ?>",
                    type        : 'POST',
                    data        : formData,
                    processData : false,
                    contentType : false,
            ...
            $('body').on('click', '.js-btn_deactivate', function (e) {
                ...
                alertify.confirm('Confirmation', 'Are you sure you want to deactivate?', function(){  
                    $.ajax({
                        url         : "<?php echo e(route('registrar.class_subjects.deactivate_data', $class_id)); ?>",
                        type        : 'POST',
