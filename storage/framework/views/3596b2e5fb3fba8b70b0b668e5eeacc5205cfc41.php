...
<div class="pull-right">
    <?php echo e($Grade8 ? $Grade8->links() : ''); ?>
...
<table class="table no-margin table-bordered table-striped">
                ...
                <tbody>                                            
                    <?php $__currentLoopData = $Grade8; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>     
                    <tr>                                         
                        ...
                        <td>
                            <div class="input-group-btn pull-left text-left">
                                ...
                                <ul class="dropdown-menu">
                                    <?php $__currentLoopData = $g_s_8; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
