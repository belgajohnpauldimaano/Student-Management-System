<table class="table no-margin table-striped table-bordered">
    <thead>
        <tr>
                ...
                <?php elseif($quarter =='First - Third'): ?>
                    <th style="width: 80px; text-align: center">First Grading</th>
                    <th style="width: 80px; text-align: center">Second Grading</th>
                    <th style="width: 80px; text-align: center">Third Grading</th>
                <?php elseif($quarter =='First - Fourth'): ?>
                    <th style="width: 80px; text-align: center">First Grading</th>
                    <th style="width: 80px; text-align: center">Second Grading</th>
                    <th style="width: 80px; text-align: center">Third Grading</th>
    ...
    <tbody> 
        ...
        <?php if($quarter == 'First - Second'): ?>
            ...
            <tr>
                ...
                <?php if(round($result_final) >= 75 && round($result_final) <= 89): ?>
                    <td>
                        <center>Passed</center>
                    </td>
                <?php elseif(round($result_final) >= 90 && round($result_final) <= 94): ?>
                    <td>
                        <center>with honors</center>
                    </td>
                <?php elseif(round($result_final)>= 95 && round($result_final) <= 97): ?>
                    <td>
                        <center>with high honors</center>
                    </td>
                <?php elseif(round($result_final) >= 98 && round($result_final) <= 100): ?>
                    <td>
                        <center>with highest honors</center>
                    </td>
                <?php elseif(round($result_final) < 75): ?>
                    <td>
