    ...
    <div class="box">
        ...
        <div class="box-body">
            <div class="js-data-container">
                <?php echo $__env->make('control_panel_finance.maintenance.online_appointment.partials.data_list', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('cms/plugins/timepicker/jquery.timepicker.js')); ?>"></script>
    <script>
        ...
        function fetch_data () {
            ...
            loader_overlay();
            $.ajax({
                url : "<?php echo e(route('finance.maintenance.queue')); ?>",
                type : 'POST',
                data : formData,
                processData : false,
                contentType : false,
        ...
        $(function () {
            ...
            $('body').on('click', '#js-button-add, .js-btn_update_sy', function (e) {
                ...
                var id = $(this).data('id');
                $.ajax({
                    url : "<?php echo e(route('finance.maintenance.queue.modal_data')); ?>",
                    type : 'POST',
            ...
            $('body').on('submit', '#js-form_other_fee', function (e) {
                ...
                $.ajax({
                    url         : "<?php echo e(route('finance.maintenance.queue.save_data')); ?>",
                    type        : 'POST',
                    data        : formData,
                    processData : false,
                    contentType : false,
            ...
            $('body').on('click', '.js-btn_deactivate', function (e) {
                ...
                alertify.confirm('Confirmation', 'Are you sure you want to deactivate?', function(){  
                    $.ajax({
                        url         : "<?php echo e(route('finance.maintenance.queue.deactivate_data')); ?>",
                        type        : 'POST',
                        data        : { _token : '<?php echo e(csrf_token()); ?>', id : id },
                        success     : function (res) {
                            $('.help-block').html('');
            ...
            $('body').on('click', '.js-btn_toggle_current', function (e) {
                ...
                alertify.confirm('Confirmation', 'Are you sure you want to '+toggle_title+' ?', function(){  
                    $.ajax({
                        url         : "<?php echo e(route('finance.maintenance.queue.toggle_current_sy')); ?>",
                        type        : 'POST',
                        data        : { _token : '<?php echo e(csrf_token()); ?>', id : id },
                        success     : function (res) {
                            $('.help-block').html('');
