    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="js-data-container">
                <?php echo $__env->make('control_panel_finance.student_payment.partials.data_list', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>       
            </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        function fetch_data () {
            ...
            loader_overlay();
            $.ajax({
                url : "<?php echo e(route('finance.student_payment')); ?>",
                type : 'POST',
                data : formData,
                processData : false,
                contentType : false,
