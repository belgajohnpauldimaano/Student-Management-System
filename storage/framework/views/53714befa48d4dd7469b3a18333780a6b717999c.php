    ...
    <script>
        ...
        $(function () {
            ...
            $('body').on('submit', '#form--change-password', function (e) {
                ...
                $.ajax({
                    url : "<?php echo e(route('finance.my_account.change_my_password')); ?>",
                    type : 'POST',
                    data : formData,
                    processData : false,
                    contentType : false,
            ...
            $('body').on('click', '.btn--update-profile', function (e) {
                e.preventDefault();
                $.ajax({
                    url : "<?php echo e(route('finance.my_account.fetch_profile')); ?>",
                    type : 'POST',
            ...
            $('body').on('submit', '#form--update-profile', function (e) {
                ...
                var formData = new FormData($(this)[0]);
                $.ajax({
                    url : "<?php echo e(route('finance.my_account.update_profile')); ?>",
                    type : 'POST',
                    data        : formData,
                    processData : false,
                    contentType : false,
            ...
            function readURL(input) {
                ...
                if (input[0].files && input[0].files[0] && (ext == "gif" || ext == "png" || ext == "jpeg" || ext == "jpg")) {
                    ...
                    reader.onload = function (e) {
                        ...
                        $.ajax({
                            url : "<?php echo e(route('finance.my_account.change_my_photo')); ?>",
                            type : 'POST',
                            data : formData,
                            processData : false,
                            contentType : false,
