            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control"><?php echo e(collect(\App\FacultyInformation::DEPARTMENTS)->firstWhere('id', $Profile->department_id)['department_name']); ?></div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control" id="display__address"><?php echo e($Profile->address); ?></div>
                    </div>
                    <div class="form-group">
                        <label for="">Birthday</label>
                        <div class="form-control" id="display__birthday"><?php echo e($Profile->birthday); ?></div>
                    </div>
                </div>
            </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        function fetch_data () {
            ...
            loader_overlay();
            $.ajax({
                url : "<?php echo e(route('admin.registrar_information')); ?>",
                type : 'POST',
                data : formData,
                processData : false,
                contentType : false,
        ...
        function fetch_educ_attainment () {
            ...
            $.ajax({
                url : "<?php echo e(route('faculty.my_account.educational_attainment')); ?>",
                type : 'POST',
        ...
        function fetch_trainings_seminar_attainment () {
            ...
            $.ajax({
                url : "<?php echo e(route('faculty.my_account.trainings_seminars')); ?>",
                type : 'POST',
                data : {_token : '<?php echo e(csrf_token()); ?>'},
                success     : function (res) {
                    loader_overlay('js-loader-overlay-trainings_seminars');
        ...
        $(function () {
            ...
            $('body').on('submit', '#form--change-password', function (e) {
                ...
                $.ajax({
                    url : "<?php echo e(route('faculty.my_account.change_my_password')); ?>",
                    type : 'POST',
                    data : formData,
                    processData : false,
                    contentType : false,
            ...
            $('body').on('click', '.btn--update-profile', function (e) {
                e.preventDefault();
                $.ajax({
                    url : "<?php echo e(route('faculty.my_account.fetch_profile')); ?>",
                    type : 'POST',
                    data        : {_token: '<?php echo e(csrf_token()); ?>'},
                    success     : function (res) {
                        $('.help-block').html('');
            ...
            $('body').on('submit', '#form--update-profile', function (e) {
                ...
                var formData = new FormData($(this)[0]);
                $.ajax({
                    url : "<?php echo e(route('faculty.my_account.update_profile')); ?>",
                    type : 'POST',
                    data        : formData,
                    processData : false,
                    contentType : false,
            ...
            $('body').on('submit', '#js-form_subject_details', function (e) {
                ...
                var formData = new FormData($(this)[0]);
                $.ajax({
                    url         : "<?php echo e(route('admin.registrar_information.save_data')); ?>",
                    type        : 'POST',
                    data        : formData,
                    processData : false,
                    contentType : false,
            ...
            function readURL(input) {
                ...
                if (input[0].files && input[0].files[0] && (ext == "gif" || ext == "png" || ext == "jpeg" || ext == "jpg")) {
                    ...
                    reader.onload = function (e) {
                        ...
                        $.ajax({
                            url : "<?php echo e(route('faculty.my_account.change_my_photo')); ?>",
                            type : 'POST',
                            data : formData,
                            processData : false,
                            contentType : false,
            ...
            $('body').on('submit', '#form--education-attainment', function (e) {
                ...
                formData.append('_token', '<?php echo e(csrf_token()); ?>');
                $.ajax({
                    url : "<?php echo e(route('faculty.my_account.educational_attainment_save')); ?>",
                    type : 'POST',
                    data : formData,
                    processData : false,
                    contentType : false,
            ...
            $('body').on('click', '.js-btn_educ_edit', function (e) {
                ...
                $.ajax({
                    url : "<?php echo e(route('faculty.my_account.educational_attainment_fetch_by_id')); ?>",
                    type : 'POST',
                    data : { _token : '<?php echo e(csrf_token()); ?>', educ_id : educ_id },
                    success     : function (res) {
                        $('.modal-education-attainment').modal({ backdrop : 'static' });
                        $('#educ_id').val(educ_id);
            ...
            $('body').on('click', '.js-btn_educ_delete', function (e) {
                ...
                alertify.confirm('Confirmation', 'Are you sure you want to delete?', function(){  
                    $.ajax({
                        url         : "<?php echo e(route('faculty.my_account.educational_attainment_delete_by_id')); ?>",
                        type        : 'POST',
                        data        : { _token : '<?php echo e(csrf_token()); ?>', educ_id : id },
                        success     : function (res) {
                            $('.help-block').html('');
                            if (res.res_code == 1)
                            {
            ...
            $('body').on('click', '.btn-trainings_seminars', function (e) {
                ...
                if (training_seminar_id) {
                    $.ajax({
                        url : "<?php echo e(route('faculty.my_account.fetch_training_seminar_by_id')); ?>",
                        type : 'POST',
                        data : { _token:'<?php echo e(csrf_token()); ?>', id : training_seminar_id },
                        success : function (res) {
                            if (res.res_code) {
                                show_toast_alert({
                                    heading : 'Invalid',
            ...
            $('body').on('submit', '#form--training-seminar', function (e) {
                ...
                $.ajax({
                    url : "<?php echo e(route('faculty.my_account.save_training_seminar')); ?>",
                    type : 'POST',
                    data : formData,
                    processData : false,
                    contentType : false,
            ...
            $('body').on('click', '.btn-seminar_delete', function (e) {
                ...
                alertify.confirm('Confirmation', 'Are you sure you want to delete?', function(){  
                    $.ajax({
                        url         : "<?php echo e(route('faculty.my_account.delete_training_seminar_by_id')); ?>",
                        type        : 'POST',
