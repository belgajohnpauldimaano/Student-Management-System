...
<?php $__env->startSection('content'); ?>    
    ...
    <div id="preloader" style="display: none">
        <img class="preloader" src="<?php echo e(asset('img/loader.gif')); ?>" alt="">
    </div>
    <div class="overlay hidden" id="js-loader-overlay"><i class="fa fa-refresh fa-spin"></i></div>
    <div class="js-data-container" style="margin-top: 10px;">
        <?php echo $__env->make('control_panel_student.enrollment.partials.data_list', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('js/custom_validator.js')); ?>"></script>
    <script>
        $('.select2').select2();
        ...
        function fetch_data () {
            ...
            loader_overlay();
            $.ajax({
                url : "<?php echo e(route('student.enrollment.index')); ?>",
                type : 'POST',
                data : formData,
                processData : false,
                contentType : false,
            ...
            if(downpayment_0 != null){
                ...
                var formData = new FormData($(this)[0]);
                        ...
                        alertify.confirm('Confirmation', 'Are you sure you want to submit? Please double check your information. Thank you', function(){  
                            $.ajax({
                                url         : "<?php echo e(route('student.enrollment.save_data')); ?>",
                                type        : 'POST',
                                data        : formData,
                                processData : false,
                                contentType : false,
        ...
        $('body').on('submit', '#js-gcash-form', function (e) {
            ...
            if(downpayment_0 != null){
                ...
                var formData = new FormData($(this)[0]);            
                        ...
                        alertify.confirm('Confirmation', 'Are you sure you want to submit? Please double check your information. Thank you', function(){  
                            $.ajax({
                                url         : "<?php echo e(route('student.enrollment.save')); ?>",
                                type        : 'POST',
                                data        : formData,
                                processData : false,
                                contentType : false,
        ...
        $('body').on('submit', '#js-checkout-form', function (e) {
            ...
            if(downpayment_0 != null){
                ...
                alertify.confirm('Confirmation', 'Are you sure you want to submit? Please double check your information. Thank you', function(){  
                    $.ajax({
                        url         : "<?php echo e(route('student.create-payment.paypal')); ?>",
                        type        : 'POST',
                        data        : formData,
                        processData : false,
                        contentType : false,   
        ...
        $('body').on('click', '.btn-transaction-history', function (e) {
            ...
            $.ajax({
                url : "<?php echo e(route('student.transaction_history.modal_account')); ?>",
                type : 'POST',
                data : { _token : '<?php echo e(csrf_token()); ?>', id : id,  school_year_id : school_year_id},
                success : function (res) {
