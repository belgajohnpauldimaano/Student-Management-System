        ...
        <?php if($GradeSheetData): ?>
            ...
            <?php $__currentLoopData = $GradeSheetData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <?php else: ?> 
                        ...
                        <?php if($data->fou_g > 0): ?>
                            <td><center><?php echo e(round($data->final_g)); ?></center></td>
                            <td><center><strong><?php echo e($data->final_g >= 75 ? 'Passed' : 'Failed'); ?></strong></center></td>
                        <?php else: ?>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <tr class="text-center">
                    <td style="text-align: right; padding-right: 1em" colspan="<?php echo e($grade_level <= 10 ? '5' : '3'); ?>"><b>General Average</b></td>
                    <td>
                        <b>
                            <?php if($data->fir_g == 0 || $data->sec_g == 0 || $data->thi_g == 0 || $data->fou_g == 0): ?>
                                
                            <?php else: ?>
                                <?php echo e($general_avg && $general_avg >= 0 ? round($general_avg) : ''); ?>

                            <?php endif; ?>
                        </b>
                    </td>
                    <?php if($data->fir_g == 0 || $data->sec_g == 0 || $data->thi_g == 0 || $data->fou_g == 0): ?>
                        <?php if($general_avg && $general_avg > 74): ?> 
                        ...
                        <?php endif; ?>
                    <?php else: ?>
                        <?php if($general_avg < 75 && $general_avg > 74): ?> 
                            <td style="color:'green';"><strong>Passed</strong></td>
                            <td></td>
                        <?php elseif($general_avg < 75): ?> 
                            <td style="color:'red';"><strong>Failed</strong></td>
...
<table border="0" style="width: 80%" class="less-m-top2">
    ...
    <tr style="margin-top: .5em">
        <td colspan="3" style="border: 0">Eligible to transfer and admission to:               
                ...
                <strong><u>&nbsp;&nbsp;<?php echo e($Enrollment[0]->eligible_transfer  ? '' : 'Grade '); ?>

                    <?php echo e($Enrollment[0]->eligible_transfer  ? $Enrollment[0]->eligible_transfer : $ClassDetail->section_grade_level + 1); ?>&nbsp;&nbsp;&nbsp;</u></strong>
    ...
    <tr style="margin-top: .5em">
        <td colspan="3" style="border: 0">Lacking units in:____<u> <?php echo e($Enrollment[0]->j_lacking_unit); ?></u>____</td>                
    </tr>
    
    <tr style="margin-top: .5em">
        <?php if($DateRemarks): ?>
            <td colspan="3" style="border: 0">Date:___<u><?php echo e($DateRemarks->j_date ? date_format(date_create( $DateRemarks->j_date ), 'F d, Y') : ''); ?></u>____</td>
        <?php else: ?>
    ...
    <tr style="margin-top: 0em">
            ...
            <table border="0" style="width: 100%; margin-top: 1.5em">
                    <tr>
                        <td style="border: 0; width: 50%;">
                            <center>
                                <?php if($ClassDetail->faculty_id == 30): ?>
                                    <img class="profile-user-img img-responsive img-circle" id="img--user_photo" src="<?php echo e($ClassDetail->e_signature ? \File::exists(public_path('/img/signature/'.$ClassDetail->e_signature)) ? asset('/img/signature/'.$ClassDetail->e_signature) : asset('/img/account/photo/blank-user.png') : asset('/img/account/photo/blank-user.png')); ?>" style="width:150px; margin-bottom: 1em">
                                <?php else: ?>
                        ...
                        <td style="border: 0; width: 50%;">
                            <center>
                                ...
                                <?php if($ClassDetail->faculty_id == 26 || $ClassDetail->faculty_id == 28 || $ClassDetail->faculty_id == 66 || $ClassDetail->faculty_id == 10|| $ClassDetail->faculty_id == 11): ?>
                                ...
                                <?php elseif($ClassDetail->faculty_id == 23): ?> 
                                    <img class="profile-user-img img-responsive img-circle" id="img--user_photo" src="<?php echo e(asset('/img/signature/principal_signature.png')); ?>" 
            ...
            <?php if($ClassDetail->faculty_id == 7): ?>
                <table border="0" style="width: 100%; margin-top: -100px; margin-bottom: 0em">     
            <?php elseif($ClassDetail->faculty_id == 20 || $ClassDetail->faculty_id == 59 || $ClassDetail->faculty_id == 21): ?>
                <table border="0" style="width: 100%; margin-top: -85px; margin-bottom: 0em">
            <?php elseif($ClassDetail->faculty_id== 68|| $ClassDetail->faculty_id == 10|| $ClassDetail->faculty_id == 11 || $ClassDetail->faculty_id == 14 || $ClassDetail->faculty_id == 30): ?>
                <table border="0" style="width: 100%; margin-top: -90px; margin-bottom: 0em">
            <?php elseif($ClassDetail->faculty_id == 66): ?>
                <table border="0" style="width: 100%; margin-top: -90px; margin-bottom: 0em">
            <?php elseif($ClassDetail->faculty_id == 26 || $ClassDetail->faculty_id == 28 || $ClassDetail->faculty_id == 65 || $ClassDetail->faculty_id == 23 || $ClassDetail->faculty_id == 62 || $ClassDetail->faculty_id == 19
                ...
                <tr>
                    <td style="border: 0; width: 50%; height: 100px">
                        <span style="margin-left: 2em; text-transform: uppercase">
                            <center>
                                <?php echo e($ClassDetail->first_name); ?> <?php echo e($ClassDetail->middle_name); ?> <?php echo e($ClassDetail->last_name); ?>
