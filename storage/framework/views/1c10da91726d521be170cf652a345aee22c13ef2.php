    ...
    <div class="box">
        ...
        <div class="box-body">            
            <div class="js-data-container">
                <?php echo $__env->make('control_panel_finance.student_finance_account.partials.data_list', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>       
            </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        function fetch_data () {
            ...
            loader_overlay();
            $.ajax({
                url : "<?php echo e(route('finance.student_acct')); ?>",
                type : 'POST',
                data : formData,
                processData : false,
                contentType : false,
        ...
        $('body').on('click', '.btn-paid', function (e) {
                ...
                alertify.confirm('Confirmation', 'Are you sure you want the status paid?', function(){  
                    $.ajax({
                        url         : "<?php echo e(route('finance.student_acct.paid')); ?>",
                        type        : 'POST',
            ...
            $('body').on('click', '.btn-unpaid', function (e) {
                ...
                alertify.confirm('Confirmation', 'Are you sure you want the status unpaid?', function(){  
                    $.ajax({
                        url         : "<?php echo e(route('finance.student_acct.unpaid')); ?>",
                        type        : 'POST',
                        data        : { _token : '<?php echo e(csrf_token()); ?>', id : id },
                        success     : function (res) {
                            $('.help-block').html('');
