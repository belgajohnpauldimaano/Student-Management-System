...
<body>
    ...
    <img style="margin-right: 3em; margin-top: <?php echo e(asset('img/sja-logo.png')); ?>" width="115" />
    <div>

    <table class="table-student-info" style="margin-top: 25px; margin-bottom: 10px">
        <tr>
            <td>School Year: <strong><?php echo e($SchoolYear->school_year); ?></strong></td>
            <td style="text-align: right">Date: <?php echo e(now()->toDateTimeString('Y-m-d')); ?></td>
        </tr>
    </table>       
            ...
            <table>
                    ...
                    <?php if($data): ?>
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td style="text-align:right"><?php echo e(number_format($data->balance, 2)); ?></td>
                                <td style="text-align:right"><?php echo e(number_format($data->payment, 2)); ?></td>
                            </tr>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td style="text-align:right"><?php echo e(number_format($dataSum,2)); ?></td>
                    </tr>
                </tfoot>
            </table>
        </div>
