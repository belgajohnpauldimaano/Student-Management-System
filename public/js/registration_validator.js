...
/***/ "./resources/assets/js/registration_validator.js":
...
function getSchoolYear() {
    $.ajax({
        ...
        success: function success(res) {
            ...
            var year = CryptoJSAesJson.decrypt(res.school_year.toString(), res.data);
            var year_data_id = CryptoJSAesJson.decrypt(res.school_year_id.toString(), res.data);
            var sy_list = CryptoJSAesJson.decrypt(res.school_year_list.toString(), res.data);
        ...
        $.ajax({
            ...
            success: function success(res) {
                ...
                if (res.res_code == 1) {
                    ...
                    alertify.alert('<i style="color: green" class="fas fa-check-circle fa-lg"></i> Confirmation', "Your email successfully submitted. Thank you!", function () {
